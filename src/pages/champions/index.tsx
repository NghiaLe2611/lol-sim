...
import { DDRAGON_LIST_STALE_MS, getSquareChampImg } from '@/constants/common';
				...
				return (
					<Tooltip key={tg}>
						<TooltipTrigger asChild>
							<span className="border-border/80 inline-flex size-7 items-center justify-center rounded border bg-muted/30">
								<img
									alt=""
									className="size-[18px] object-contain filter-icon"
									src={meta.src}
									height={18}
									width={18}
								/>
								...
								>
									<div className="aspect-square overflow-hidden bg-secondary relative">
										<img
											...
											// c.id, c.name c.key
										/>
										{/* <div className="w-full absolute bottom-0 left-0 bg-[#02111f84]">
											<ChampionCardTagIcons tags={c.tags} />
										</div> */}
									</div>
									<div className="p-2 space-y-2">
										<h5 className="display text-base font-medium text-hex-gold">
											{c.name}
										</h5>
