...
export function bonusStatAbbreviation(key: string): { short: string; label: string } {
	const preset: Record<string, { short: string; label: string }> = {
		...
		abilityPower: { short: 'AP', label: 'Magic Damage' },
		...
		criticalStrikeChance: { short: 'Crit Chance', label: 'Critical Strike Chance' },
		criticalStrikeDamage: { short: 'Crit Dmg', label: 'Critical Strike Damage' },
		criticalStrikeDamageModifier: {
			short: 'Crit Mod',
			label: 'Critical Strike Damage Modifier',
		},
		abilityHaste: { short: 'Ability Haste', label: 'Ability Haste' },
		lethality: { short: 'Lethality', label: 'Lethality' },
		omnivamp: { short: 'Omnivamp', label: 'Omnivamp' },
