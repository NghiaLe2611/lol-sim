...
export default function VersionTag() {
	...
	return (
		<div className="inline-flex items-center gap-2 rounded-md border border-border px-3 py-1 text-xs tabular-nums tracking-wide text-hex-gold light:bg-white/80">
