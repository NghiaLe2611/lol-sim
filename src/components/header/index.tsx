...
export function Header() {
	...
	return (
		<header className="border-border/60 bg-background/70 sticky top-0 z-40 border-b shadow-[0_4px_6px_-1px_rgba(83,83,83,0.1)] backdrop-blur-md light:bg-sky-100/5 dark:shadow-[0_4px_6px_-1px_#0a2738]">
