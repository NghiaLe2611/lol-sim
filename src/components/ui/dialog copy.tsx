...
// import { isMobile } from '@/lib/client/helpers';
...
type DialogAnimations = 'fade' | 'slide-top' | 'slide-bottom';
type DialogPositions = 'top' | 'center' | 'bottom';
...
>(
	(
		...
		const positionClasses = {
			center: 'top-[50%] translate-y-[-50%] data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-top-[48%]',
			top: ' top-16 translate-y-[0] data-[state=closed]:slide-out-to-top-16 data-[state=open]:slide-in-from-top-16',
			bottom: 'bottom-16 top-auto translate-y-[0] data-[state=closed]:slide-out-to-bottom-16 data-[state=open]:slide-in-from-bottom-16',
		};
